...
window.onload = function () {
    ...
    for (let i = firstLin; i < dayOfWeek; i++) { table.rows[i].cells[1].style.visibility = 'hidden'; }
    for (let i = dayOfWeek+1; i < numLins; i++) { table.rows[i].cells[numCols-1].style.visibility = 'hidden'; }
}
